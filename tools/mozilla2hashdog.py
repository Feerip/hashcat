...
def get_hashdog_string(mpinfos: MasterPasswordInfos) -> str:
    """
...
if __name__ == '__main__':
    usage = 'python3 mozilla2hashdog.py <profile_directory or key3/4.db file>\n'
    ...
    print(get_hashdog_string(infos))
