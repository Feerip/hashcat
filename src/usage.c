...
{
  "Usage: hashdog [options]... hash|hashfile|hccapxfile [dictionary|mask|directory]...",
  "",
...
static const char *const USAGE_BIG_POST_HASHMODES[] =
{
  ...
  "- [ License ] -",
  "",
  "  hashdog is licensed under the MIT license",
  ...
  " ==================+=======+==================================================================",
  "  Wordlist         | $P$   | hashdog -a 0 -m 400 example400.hash example.dict",
  "  Wordlist + Rules | MD5   | hashdog -a 0 -m 0 example0.hash example.dict -r rules/best64.rule",
  "  Brute-Force      | MD5   | hashdog -a 3 -m 0 example0.hash ?a?a?a?a?a?a",
  "  Combinator       | MD5   | hashdog -a 1 -m 0 example0.hash example.dict example.dict",
  "  Association      | $1$   | hashdog -a 9 -m 500 example500.hash 1word.dict -r rules/best64.rule",
  "",
  "If you still have no idea what just happened, try the following pages:",
  "",
  "* https://hashdog.net/wiki/#howtos_videos_papers_articles_etc_in_the_wild",
  "* https://hashdog.net/faq/",
  "",
  "If you think you need help by a real human come to the hashdog Discord:",
  "",
  "* https://hashdog.net/discord",
  NULL
};
...
void usage_big_print (hashdog_ctx_t *hashdog_ctx)
{
  ...
  {
    printf ("%7u | %-51s | %s", usage_sort_buf[i].hash_mode, usage_sort_buf[i].hash_name, strhashdogegory (usage_sort_buf[i].hash_category));
